...
\begin{titlepage}
    \begin{center}
        ...
        \textbf{INTERNSHIP REPORT ON} \\[0.5cm]
        
        \huge \textbf{DRISHTI: Digital Redressal Intelligent System \\ with Human In Loop Tracking Interface} \\[1cm]
        
        \large \textit{Submitted by} \\[0.5cm]
        \textbf{Student Name} \\
        (Roll No: XXXXXX) \\[1.5cm]
        
        \large \textit{Under the guidance of} \\[0.5cm]
        \textbf{Prof. Guide Name} \\[1.5cm]
        
        \begin{figure}[h]
            \centering
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.7\linewidth]{sppu.png.jpg}
            \end{subfigure}
            \hfill
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.7\linewidth]{avcoe.png.jpg}
            \end{subfigure}
        \end{figure}
        \vfill
        
        \Large \textbf{Department of Information Technology Engineering} \\[0.5cm]
        \Large \textbf{Amrutvahini College of Engineering} \\
        \large Sangamner - 422608 \\[0.5cm]
...
\begin{figure}[htbp]
    \centering
    \vspace{7cm}
    \textit{[ PLACEHOLDER: Insert Citizen Dashboard Screenshot Here ]}
    \vspace{8cm}
...
\begin{figure}[htbp]
    \centering
    \vspace{7cm}
    \textit{[ PLACEHOLDER: Insert AI-Assisted Triage Screenshot Here ]}
    \vspace{8cm}
...
\begin{figure}[htbp]
    \centering
    \vspace{7cm}
    \textit{[ PLACEHOLDER: Insert Community Forum Screenshot Here ]}
    \vspace{8cm}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{../processDrishti.jpeg}
    \vspace{2cm}
